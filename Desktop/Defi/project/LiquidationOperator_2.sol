...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function operate() external {
        ...
        //console.log("uniswapV2Pair(%s): WBTC <> WETH",address(WBTC));  // check
    ...
    function uniswapV2Call(
        ...
        uint repay_BTC = getAmountIn(debtToCover, reserve_WBTC_Pool1, reserve_USDT_Pool1);
        WBTC.transfer(address(uniswapV2Pair_WBTC_USDT), repay_BTC);
       
       collateral_WBTC -= repay_BTC;

       
        WBTC.transfer(address(uniswapV2Pair_WBTC_WETH), collateral_WBTC);  // 2.2 swap WBTC for other things or repay directly
